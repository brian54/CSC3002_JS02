...
public class Fooddescription_soup extends AppCompatActivity {

    ImageView foodimageView;
    TextView foodtextView;

    /** A descriptive soup menu with individual menu's photo and name */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fooddescription_soup);
